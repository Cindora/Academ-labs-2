...
namespace MyMenu
{
    public static class Constants
    {
        ...
        public static string[] MenuStr = { "Моё меню\n", "Главное меню",
            "Нажмите для просмотра особенностей класса героя:", "Выберите желаемое действие:","Открыть хранилище продуктов",
                "Показать рецепты блюд","Составить быстрое меню на день" };
